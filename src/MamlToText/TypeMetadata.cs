...
namespace Microsoft.CLU.Metadata
{
    ...
    internal class TypeMetadata : IMetadata
    {
        ...
        public TypeMetadata(Type cmdletType)
        {
            ...
            var cmdletAttributes = cmdletType.GetTypeInfo().GetCustomAttributes().Where((a) => a.GetType().FullName == "System.Management.Automation.CmdletAttribute" || a.GetType().FullName == "System.Management.Automation.PSCmdletAttribute");
